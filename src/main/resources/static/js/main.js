...
if (firstTime === "true") {
    ...
    const driverObj = driver({
        ...
        steps: [
            ...
            {element: '#some-element', popover: {title: 'That"s all for now!', description: 'Congratulations! You\'re ready to start documenting your travels on the map and create a visual diary of your adventures. Explore more countries, upload more photos, and let your travel map tell the story of your incredible journey.\n' +
                        '\n' +
